...
public class OI {
    ...
    public JoystickButton closeHandsButton;
    public JoystickButton openhandsButton;
    ...
    public OI() {
        ...
        openhandsButton = new JoystickButton(opStick, 2);
        openhandsButton.whileHeld(new OpenHands());
        closeHandsButton = new JoystickButton(opStick, 1);
        closeHandsButton.whileHeld(new CloseHands());
        ...
        SmartDashboard.putData("TimedForward: timeout", new TimedForward(1));
