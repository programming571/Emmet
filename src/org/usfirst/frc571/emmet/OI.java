...
public class OI {
    ...
    public OI() {
        ...
        turnRightButton = new JoystickButton(opStick, 6);
        turnRightButton.whenPressed(new Turn(90.0));

        turnRightButton = new JoystickButton(opStick, 5);
        turnRightButton.whenPressed(new Turn(0.0));
