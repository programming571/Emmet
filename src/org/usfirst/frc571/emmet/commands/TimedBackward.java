 ...
 *
 */
public class TimedBackward extends TimedCommand {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
	double timeout;

    public TimedBackward() {
        this(0);
    }

    public TimedBackward(double timeout) {
    	super(timeout);
    ...
    @Override
    protected void end() {
    	System.out.println("TimedBackward timeout: " + timeout);
